...
public class UIManager : Singleton<UIManager>
{
    ...
    // UI 관리
    // ================================
    public async void OpenUI<T>() where T : UIBase
    {
    ...
    public async UniTask<T> GetUI<T>() where T : UIBase
    {
    ...
    private async UniTask<T> CreateUI<T>() where T : UIBase
    {
        if (_isCleaning) return null;
